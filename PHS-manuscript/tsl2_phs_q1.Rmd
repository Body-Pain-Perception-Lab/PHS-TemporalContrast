...
if (!require("pacman")) install.packages("pacman")
  pacman::p_load(DHARMa, lme4, lmerTest, tidyverse, rcompanion, Rmisc, emmeans)
```
...
# effectsizes are inverselog OR, calculate OR for each effect
# not sure where to access the stat in the data-frame so do this manually for now (not ideal)
inn3238 <- inv.logit(-.573)
inn3244 <- inv.logit(-1.62)
inn3844 <- inv.logit(-1.07)
nox3238 <- inv.logit(.364)
nox3244 <- inv.logit(.759)
nox3844 <- inv.logit(.394)
```
