...
imwrite(A,map,'PHS_results_181_ver3.gif','LoopCount',65535,'DelayTime',0.01);

% Legend
hold on
plot(3, 49, 'Color', [0.5 0.5 0.5], 'Marker', 'd', 'MarkerFaceColor', [0.5 0.5 0.5], 'MarkerSize', 10); % diamond
text(5, 49, 'Auditory cue', 'FontSize',12)
plot(3, 47, 'Color', 'k', 'Marker', 'o', 'MarkerSize', 10);
plot(3, 47, 'Color', 'k', 'Marker', 'o', 'MarkerFaceColor', rgb_cold, 'MarkerSize', 8);
text(5, 47, 'Button Press: Thermal change', 'FontSize',12)
