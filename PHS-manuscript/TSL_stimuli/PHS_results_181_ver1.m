...
mean_temperatures = [38 30.08 38 29.43 38 29.03];
...
imwrite(A,map,'PHS_results_181.gif','LoopCount',65535,'DelayTime',0.01);

% Legend
hold on
plot(3, 49, 'Color', [0.5 0.5 0.5], 'Marker', 'd', 'MarkerFaceColor', [0.5 0.5 0.5], 'MarkerSize', 10); % diamond
text(5, 49, 'Auditory cue', 'FontSize',12)
plot(3, 47, 'Color', rgb_coldp, 'Marker', 'o', 'MarkerSize', 10);
plot(3, 47, 'Color', rgb_coldp, 'Marker', 'o', 'MarkerFaceColor', rgb_cold, 'MarkerSize', 8);
text(5, 47, 'Button Press: Cold', 'FontSize',12)
plot(3, 45, 'Color', rgb_warmp, 'Marker', 'o', 'MarkerSize', 10);
plot(3, 45, 'Color', rgb_warmp, 'Marker', 'o', 'MarkerFaceColor', rgb_warm, 'MarkerSize', 8);
text(5, 45, 'Button Press: PHS', 'FontSize',12)
% baseline 
...
% segment 1: WDT 1
% xint = x0;
t1 = baseline; t2 = mean_temperatures(1);  beep = 0; button_press = 0;
...
plot_animatedline(t1, t2, int, rgb_cold, xint, beep, button_press, rgb_coldp, et)
...
function plot_animatedline(t1,t2,int, color, x0, beep, button_press, bp_color, et)
    ...
    set(gca, 'XLim', [0 round(et)], 'YLim', [15 50], 'FontSize',12) % X-axis and Y-axis limits
    ...
    for ii = 1:length(x)
        ...
        drawnow
        [A,map] = rgb2ind(frame2im(getframe),256);
        imwrite(A,map,'PHS_results_181.gif','WriteMode','append','DelayTime',0.01);
    end
