...
mean_temperatures = [38.87 26.71 41.22 24.54 42.94 18.50];
PHS = [0 0 0 1 0 1];
%sd_temperatures = [0 0.96 0 1.23 0 1.39];
int = 0.1;
...
%%
animation_fname = 'PHS_results_181_subjELS26.gif';
[A,map] = rgb2ind(frame2im(getframe),256);
imwrite(A,map,animation_fname,'LoopCount',65535,'DelayTime',0.01);

% Legend
hold on
%plot(5, 49, 'Color', [0.5 0.5 0.5], 'Marker', 'd', 'MarkerFaceColor', [0.5 0.5 0.5], 'MarkerSize', 10); % diamond
%text(8, 49, 'Auditory cue', 'FontSize',12)
% plot(5, 47, 'Color', rgb_coldp, 'Marker', 'o', 'MarkerSize', 10);
% plot(5, 47, 'Color', rgb_coldp, 'Marker', 'o', 'MarkerFaceColor', rgb_cold, 'MarkerSize', 8);
% text(8, 47, 'Button Press: Cold', 'FontSize',12)
% plot(5, 45, 'Color', rgb_warmp, 'Marker', 'o', 'MarkerSize', 10);
% plot(5, 45, 'Color', rgb_warmp, 'Marker', 'o', 'MarkerFaceColor', rgb_cold, 'MarkerSize', 8);
% text(8, 45, 'Button Press: PHS', 'FontSize',12)

% Legend
hold on
plot(5, 9, 'Color', rgb_warmp, 'Marker', 'o', 'MarkerSize', 10);
plot(5, 9, 'Color', rgb_warmp, 'Marker', 'o', 'MarkerFaceColor', rgb_warm, 'MarkerSize', 8);
text(8, 9, 'Button Press: Warm', 'FontSize',12)
plot(5, 7, 'Color', rgb_coldp, 'Marker', 'o', 'MarkerSize', 10);
plot(5, 7, 'Color', rgb_coldp, 'Marker', 'o', 'MarkerFaceColor', rgb_cold, 'MarkerSize', 8);
text(8, 7, 'Button Press: Cold', 'FontSize',12)
plot(5, 5, 'Color', rgb_warmp, 'Marker', 'o', 'MarkerSize', 10);
plot(5, 5, 'Color', rgb_warmp, 'Marker', 'o', 'MarkerFaceColor', rgb_cold, 'MarkerSize', 8);
text(8, 5, 'Button Press: PHS', 'FontSize',12)
xpos = - 4;
ypos = 2;

%baseline 
t1 = baseline; t2 = baseline; beep = 0; button_press = 0;
plot_animatedline(t1, t2, int,reds5{1}, xint, beep, button_press, rgb_warmp, et, animation_fname)

% segment 1: WDT 1
% xint = x0;
t1 = baseline; t2 = mean_temperatures(1);  beep = 0; button_press = 1;
...
xbase = xint + xpos;
ybase = mean_temperatures(1) + ypos;
...
t1 = mean_temperatures(1); t2 = baseline; beep = 0; button_press = 0; 
plot_animatedline(t1, t2, int, rgb_warm, xint, beep, button_press, rgb_warmp, et, animation_fname)
...
if PHS(2) == 0; bp_color = rgb_coldp; else; bp_color = rgb_warmp; end
plot_animatedline(t1, t2, int, rgb_cold, xint, beep, button_press, bp_color, et, animation_fname)
xint = xint + abs(t1-t2); % determine x-axis coordinate where to plot the next segment and draw text 
xT_m = xint + xpos; yT_m = mean_temperatures(2) - ypos; % T stands for Threshold, m for mean, s for std
%xT_s = xint - 2.5; yT_s = mean_temperatures(2) - 3.6;
text(xT_m,yT_m,[num2str(mean_temperatures(2)) char(176) 'C'], 'FontSize',12); % add a text (temperature in C) to the plot
...
% segment 5: WDT 2
t1 = baseline; t2 = mean_temperatures(3); beep = 0; button_press = 1;
plot_animatedline(t1, t2, int, rgb_warm, xint, beep, button_press, rgb_warmp, et, animation_fname)
xint = xint + abs(t1-t2); % determine x-axis coordinate where to plot the next segment and draw text
xbase = xint + xpos;
ybase = mean_temperatures(3) + ypos;
text(xbase,ybase,[num2str(mean_temperatures(3)) char(176) 'C'], 'FontSize',12);

% segment 6: return to baseline
t1 = mean_temperatures(3); t2 = baseline; beep = 0; button_press = 0; 
plot_animatedline(t1, t2, int, rgb_warm, xint, beep, button_press, rgb_warmp, et, animation_fname)
xint = xint + abs(t1-t2); % determine x-axis coordinate where to plot the next segment

% segment 7: CDT 2
t1 = baseline; t2 = mean_temperatures(4); beep = 0; button_press = 1;
if PHS(4) == 0; bp_color = rgb_coldp; else; bp_color = rgb_warmp; end
plot_animatedline(t1, t2, int, rgb_cold, xint, beep, button_press, bp_color, et, animation_fname)
xint = xint + abs(t1-t2); % determine x-axis coordinate where to plot the next segment and draw text
xT_m = xint + xpos; yT_m = mean_temperatures(4) - ypos; % T stands for Threshold, m for mean, s for std
%xT_s = xint - 2.5; yT_s = mean_temperatures(4) - 3.6;
text(xT_m,yT_m,[num2str(mean_temperatures(4)) char(176) 'C'], 'FontSize',12); % add a text (temperature in C) to the plot
...
% segment 9: WDT 3
t1 = baseline; t2 = mean_temperatures(5);  beep = 0; button_press = 1;
plot_animatedline(t1, t2, int, rgb_warm, xint, beep, button_press, rgb_warmp, et, animation_fname)
xint = xint + abs(t1-t2); % determine x-axis coordinate where to plot the next segment and draw text
xbase = xint + xpos;
ybase = mean_temperatures(5) + ypos;
text(xbase,ybase,[num2str(mean_temperatures(5)) char(176) 'C'], 'FontSize',12);

% segment 10: return to baseline
t1 = mean_temperatures(5); t2 = baseline; beep = 0; button_press = 0;
plot_animatedline(t1, t2, int, rgb_warm, xint, beep, button_press, rgb_warmp, et, animation_fname)
xint = xint + abs(t1-t2); % determine x-axis coordinate where to plot the next segment
...
plot_animatedline(t1, t2, int, rgb_cold, xint, beep, button_press, bp_color, et, animation_fname)
xint = xint + abs(t1-t2); % determine x-axis coordinate where to plot the next segment and draw text
xT_m = xint + xpos; yT_m = mean_temperatures(6) - ypos; % T stands for Threshold, m for mean, s for std
%xT_s = xint - 2.5; yT_s = mean_temperatures(6) - 3.6;
text(xT_m,yT_m,[num2str(mean_temperatures(6)) char(176) 'C'], 'FontSize',12); % add a text (temperature in C) to the plot
