...
mean_temperatures = [38.24 32.51 41.47 35.47 43.56 37.78];
PHS = [0 1 0 1 0 1];
...
%%
animation_fname = 'PHS_results_181_subjELS_NoCold.gif';
[A,map] = rgb2ind(frame2im(getframe),256);
imwrite(A,map,animation_fname,'LoopCount',65535,'DelayTime',0.01);

% Legend
hold on
plot(2, 49, 'Color', rgb_warmp, 'Marker', 'o', 'MarkerSize', 10);
plot(2, 49, 'Color', rgb_warmp, 'Marker', 'o', 'MarkerFaceColor', rgb_warm, 'MarkerSize', 8);
text(4, 49, 'Button Press: Warm', 'FontSize',12)
plot(2, 47, 'Color', rgb_coldp, 'Marker', 'o', 'MarkerSize', 10);
plot(2, 47, 'Color', rgb_coldp, 'Marker', 'o', 'MarkerFaceColor', rgb_cold, 'MarkerSize', 8);
text(4, 47, 'Button Press: Cold', 'FontSize',12)
plot(2, 45, 'Color', rgb_warmp, 'Marker', 'o', 'MarkerSize', 10);
plot(2, 45, 'Color', rgb_warmp, 'Marker', 'o', 'MarkerFaceColor', rgb_cold, 'MarkerSize', 8);
text(4, 45, 'Button Press: PHS', 'FontSize',12)
xpos = - 2;
ypos = 2;
...
t1 = mean_temperatures(1); t2 = mean_temperatures(2); beep = 0; button_press = 1;
...
% if PHS(2) == 0; bp_color = rgb_coldp; else; bp_color = rgb_warmp; end
% plot_animatedline(t1, t2, int, rgb_warm, xint, beep, button_press, bp_color, et, animation_fname)
...
% segment 5: WDT 2
t1 =  mean_temperatures(2); t2 = mean_temperatures(3); beep = 0; button_press = 1;
plot_animatedline(t1, t2, int, rgb_warm, xint, beep, button_press, rgb_warmp, et, animation_fname)
xint = xint + abs(t1-t2); % determine x-axis coordinate where to plot the next segment and draw text
xbase = xint + xpos;
...
t1 = mean_temperatures(3); t2 = mean_temperatures(4); beep = 0; button_press = 1; 
plot_animatedline(t1, t2, int, rgb_warm, xint, beep, button_press, rgb_warmp, et, animation_fname)
xint = xint + abs(t1-t2); % determine x-axis coordinate where to plot the next segment
...
% segment 9: WDT 3
t1 = mean_temperatures(4); t2 = mean_temperatures(5);  beep = 0; button_press = 1;
plot_animatedline(t1, t2, int, rgb_warm, xint, beep, button_press, rgb_warmp, et, animation_fname)
xint = xint + abs(t1-t2); % determine x-axis coordinate where to plot the next segment and draw text
xbase = xint + xpos;
...
t1 = mean_temperatures(5); t2 = mean_temperatures(6); beep = 0; button_press = 1;
plot_animatedline(t1, t2, int, rgb_warm, xint, beep, button_press, rgb_warmp, et, animation_fname)
xint = xint + abs(t1-t2); % determine x-axis coordinate where to plot the next segment
