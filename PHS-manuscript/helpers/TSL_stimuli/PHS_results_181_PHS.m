...
text(5, 45, 'Detection Threshold: Cold', 'FontSize',12)

plot(3, 42, 'Color', rgb_warmp, 'Marker', 'o', 'MarkerSize', 10);
plot(3, 42, 'Color', rgb_warmp, 'Marker', 'o', 'MarkerFaceColor', rgb_cold, 'MarkerSize', 8);
text(5, 42, 'Detection Threshold: PHS', 'FontSize',12)
